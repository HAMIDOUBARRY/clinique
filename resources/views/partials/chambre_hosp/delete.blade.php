        ...
        <div class="modal-content">
            <div class="modal-body text-center font-18">
                ...
                <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto">
                    ...
                    <div class="col-6">
                        <form id="delete-form{{$hospitalisation->id}}" action="{{ route('chambrehospitalisation.destroy', $hospitalisation->id) }}"
                            method="POST">
                            @csrf
                            
                            @method('DELETE')
                            <button type="submit" class="btn btn-success border-radius-100 btn-block confirmation-btn">

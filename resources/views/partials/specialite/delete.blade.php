<div class="col-md-4 col-sm-12 mb-30">
    <div class="modal fade" id="confirmation-modal{{$specialite->id}}" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body text-center font-18">
                    ...
                    <div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto">
                        ...
                        <div class="col-6">
                            <form id="delete-form" action="{{ route('specialite.destroy', $specialite->id) }}"
                                method="POST">
